...
import { deleteBrandPage } from "./actions";
...
export function PageRowActions({
  ...
  const handleConfirm = () => {
    startTransition(async () => {
      const result = await deleteBrandPage({ pageId });
      if (!result.ok) {
      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ¿Confirmás eliminar &ldquo;{pageTitle}&rdquo;? La página se moverá a la papelera y
              dejará de aparecer en el sitio.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel
